...
VATMpad.prototype = {
  ...
  _create_numpad: function(container_id, parent)
  {
    ...
    var kb_pad_7 = this._setup_key(parent, "___pad_7", gap + "px", edge, cp, cp, bc, kc, lh, fs);
    kb_pad_7.innerHTML = "7";

    var edge_1 = String(this._findX(kb_pad_7) + this._findW(kb_pad_7) + gap) + "px";

    var kb_pad_8 = this._setup_key(parent, "___pad_8", gap + "px", edge_1, cp, cp, bc, kc, lh, fs);
    kb_pad_8.innerHTML = "8";

    var edge_2 = String(this._findX(kb_pad_8) + this._findW(kb_pad_8) + gap) + "px";

    var kb_pad_9 = this._setup_key(parent, "___pad_9", gap + "px", edge_2, cp, cp, bc, kc, lh, fs);
    kb_pad_9.innerHTML = "9";

    var prevH = this._findH(kb_pad_9), edge_Y = (this._findY(kb_pad_9) + prevH + gap) + "px";
    ...
    var kb_pad_enter = this._setup_key(parent, "___pad_period", edge_Y, edge_1, String(2 * cell + gap) + "px", cp, bc, kc, lh, parseFloat(fs) * 0.9, n);
    kb_pad_enter.innerHTML = "Enter";

    this.LastKey = kb_pad_enter;

    return String(this._findX(kb_pad_9) + this._findW(kb_pad_9) + gap) + "px";
  },
